  ...
  return (
    <section id="home" className="h-screen flex items-center relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 bg-primary bg-opacity-50 flex justify-between items-center px-6 py-1 border-b border-muted border-opacity-10">
        ...
        <div className="font-mono text-xs text-muted">~DEVPRASAD B M</div>
      </div>

      <div className="container-custom"> {/* Main container for hero content */}

        {/* Avatar Element - Added Here */}
        <div className="hidden md:block absolute top-1/2 right-20 lg:right-34 transform -translate-y-1/2 z-10">
          <Avatar />
        </div>
        ...
        >
          ...
          >
            ...
            <div className="nothing-headline font-mono tracking-wide">
              <DottedText text="DEVPRASAD B M" />
            </div>
            <div className="mt-2 text-gradient">FULL-STACK Developer</div>
          </motion.h1>

          <motion.p
            variants={childVariants}
            className="text-muted text-lg md:text-xl mb-10 max-w-l"
          >
            Full-stack developer with hands-on experience in web,  <br/>
            API, and ML-integrated systems. <br/>
            I build practical, scalable solutions with a <br/>
          ...
          >
            <a href="https://github.com/devprasadbm23" target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://www.linkedin.com/in/devprasad-b-m-012778265/" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-2 text-sm text-muted hover:text-light transition-colors">
              <svg className="social-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
          ...
          >
            ...
            <a href="/res.pdf" target="_blank" rel="noopener noreferrer" className="nothing-btn">
              RESUME
