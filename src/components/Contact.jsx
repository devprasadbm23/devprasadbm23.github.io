...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const templateParams = {
      ...
      to_email: 'devprasadbm0@gmail.com',
      date_time: formattedDate,
      user_login: 'devprasadbm'
    };
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <a href="mailto:devprasadbm0@gmail.com" className="text-muted hover:text-light transition-colors">
                    devprasadbm0@gmail.com
                  </a>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <a href="tel:+919900112530" className="text-muted hover:text-light transition-colors">
                    +91 9900112530
                  </a>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="flex gap-3 mt-2">
                    {/* GitHub */}
                    <a href="https://github.com/devprasadbm23" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
                    ...
                    {/* LinkedIn */}
                    <a href="https://www.linkedin.com/in/devprasad-b-m-012778265/" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
